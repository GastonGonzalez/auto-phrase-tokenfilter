...
public class TestAutoPhrasingTokenFilter extends TestCase {
  ...
  public void testAutoPhrase( ) throws Exception {
    final CharArraySet phraseSets = new CharArraySet( Version.LUCENE_45, Arrays.asList(
    ...
    final WhitespaceTokenizer in = new WhitespaceTokenizer(Version.LUCENE_45, reader );
